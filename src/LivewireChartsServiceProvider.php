...
use Aabosham\LivewireCharts\Charts\LivewireAreaChart;
use Aabosham\LivewireCharts\Charts\LivewireColumnChart;
use Aabosham\LivewireCharts\Charts\LivewireLineChart;
use Aabosham\LivewireCharts\Charts\LivewirePieChart;
use Aabosham\LivewireCharts\Charts\LivewireRadialBarChart;
...
class LivewireChartsServiceProvider extends ServiceProvider
{
    ...
    private function registerComponents()
    {
        ...
        Livewire::component('livewire-radial-bar-chart', LivewireRadialBarChart::class);
    }
